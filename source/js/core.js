...
class Scrollbar extends Component{
    ...
    set(options_length){
        ...
        this.dropdown.content.options = new Component(this.dropdown.content.elem.querySelectorAll('.cwc-select-option'));
        ...
        this.dropdown.content.set(
            ...
            0,
            this.dropdown.content.options[0].offsetHeight
        );
        if(hidden_options !== 0) {
    ...
    */
    ...
    mouseMove(event){
        ...
        console.log(this.dropdown.track.thumb.elem.offsetHeight/2);
